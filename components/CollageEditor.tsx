...
// TYPES
// =============================================
interface CollageCell { x:number; y:number; w:number; h:number; clip?:string }
interface CollageLayout { id:string; name:string; photoCount:number; category:'kotak'|'diagonal'|'chevron'|'gelombang'; cells:CollageCell[] }
interface CellState { imageSrc:string|null; imgNaturalW:number; imgNaturalH:number; scale:number; offsetX:number; offsetY:number }
...
interface StagedPhoto { imageSrc:string; imgNaturalW:number; imgNaturalH:number }
...
const DEFAULT_CELL = ():CellState => ({ imageSrc:null, imgNaturalW:0, imgNaturalH:0, scale:1, offsetX:0, offsetY:0 });
...
const COLLAGE_LAYOUTS: CollageLayout[] = [
  ...
  { id:'d2_slash', name:'2 Miring /',  category:'diagonal', photoCount:2, cells:[{x:0,y:0,w:100,h:100,clip:'0 0,60 0,40 100,0 100'},{x:0,y:0,w:100,h:100,clip:'60 0,100 0,100 100,40 100'}] },
  { id:'d2_back',  name:'2 Miring \\', category:'diagonal', photoCount:2, cells:[{x:0,y:0,w:100,h:100,clip:'0 0,40 0,60 100,0 100'},{x:0,y:0,w:100,h:100,clip:'40 0,100 0,100 100,60 100'}] },
  { id:'d2_horiz', name:'2 Miring Horisontal', category:'diagonal', photoCount:2, cells:[{x:0,y:0,w:100,h:100,clip:'0 0,100 0,100 40,0 60'},{x:0,y:0,w:100,h:100,clip:'0 60,100 40,100 100,0 100'}] },
  { id:'d3_strips',name:'3 Strip Diagonal', category:'diagonal', photoCount:3, cells:[{x:0,y:0,w:100,h:100,clip:'0 0,36 0,22 100,0 100'},{x:0,y:0,w:100,h:100,clip:'36 0,70 0,56 100,22 100'},{x:0,y:0,w:100,h:100,clip:'70 0,100 0,100 100,56 100'}] },
  { id:'d4_strips',name:'4 Strip Diagonal', category:'diagonal', photoCount:4, cells:[{x:0,y:0,w:100,h:100,clip:'0 0,28 0,16 100,0 100'},{x:0,y:0,w:100,h:100,clip:'28 0,53 0,41 100,16 100'},{x:0,y:0,w:100,h:100,clip:'53 0,78 0,66 100,41 100'},{x:0,y:0,w:100,h:100,clip:'78 0,100 0,100 100,66 100'}] },
  { id:'d4_x',     name:'4 Segitiga X', category:'diagonal', photoCount:4, cells:[{x:0,y:0,w:100,h:100,clip:'0 0,100 0,50 50'},{x:0,y:0,w:100,h:100,clip:'100 0,100 100,50 50'},{x:0,y:0,w:100,h:100,clip:'0 100,100 100,50 50'},{x:0,y:0,w:100,h:100,clip:'0 0,50 50,0 100'}] },
  { id:'d3_fan',   name:'3 Kipas Pojok', category:'diagonal', photoCount:3, cells:[{x:0,y:0,w:100,h:100,clip:'0 100,0 0,100 0'},{x:0,y:0,w:100,h:100,clip:'0 100,100 0,100 55,45 100'},{x:0,y:0,w:100,h:100,clip:'0 100,45 100,100 55,100 100'}] },
  { id:'c2_right', name:'2 Panah →', category:'chevron', photoCount:2, cells:[{x:0,y:0,w:100,h:100,clip:'0 0,55 0,78 50,55 100,0 100'},{x:0,y:0,w:100,h:100,clip:'55 0,100 0,100 100,55 100,78 50'}] },
  { id:'c2_left',  name:'2 Panah ←', category:'chevron', photoCount:2, cells:[{x:0,y:0,w:100,h:100,clip:'0 0,45 0,22 50,45 100,0 100'},{x:0,y:0,w:100,h:100,clip:'45 0,100 0,100 100,45 100,22 50'}] },
  { id:'c2_v',     name:'2 Bentuk V', category:'chevron', photoCount:2, cells:[{x:0,y:0,w:100,h:100,clip:'0 0,100 0,50 60,0 100'},{x:0,y:0,w:100,h:100,clip:'0 100,50 60,100 0,100 100'}] },
  { id:'c3_right', name:'3 Chevron →', category:'chevron', photoCount:3, cells:[{x:0,y:0,w:100,h:100,clip:'0 0,28 0,50 50,28 100,0 100'},{x:0,y:0,w:100,h:100,clip:'28 0,62 0,84 50,62 100,28 100,50 50'},{x:0,y:0,w:100,h:100,clip:'62 0,100 0,100 100,62 100,84 50'}] },
  { id:'c3_left',  name:'3 Chevron ←', category:'chevron', photoCount:3, cells:[{x:0,y:0,w:100,h:100,clip:'0 0,38 0,16 50,38 100,0 100'},{x:0,y:0,w:100,h:100,clip:'38 0,72 0,50 50,72 100,38 100,16 50'},{x:0,y:0,w:100,h:100,clip:'72 0,100 0,100 100,72 100,50 50'}] },
  { id:'c4_chain', name:'4 Rantai →', category:'chevron', photoCount:4, cells:[{x:0,y:0,w:100,h:100,clip:'0 0,30 0,42 50,30 100,0 100'},{x:0,y:0,w:100,h:100,clip:'30 0,55 0,67 50,55 100,30 100,42 50'},{x:0,y:0,w:100,h:100,clip:'55 0,78 0,90 50,78 100,55 100,67 50'},{x:0,y:0,w:100,h:100,clip:'78 0,100 0,100 100,78 100,90 50'}] },
  { id:'g2_vert',  name:'2 Gelombang |', category:'gelombang', photoCount:2, cells:[{x:0,y:0,w:100,h:100,clip:'0 0,46 0,50 8,55 17,57 25,55 33,50 42,45 50,43 58,46 67,52 75,54 83,52 92,48 100,0 100'},{x:0,y:0,w:100,h:100,clip:'46 0,100 0,100 100,48 100,52 92,54 83,52 75,46 67,43 58,45 50,50 42,55 33,57 25,55 17,50 8'}] },
  { id:'g2_horiz', name:'2 Gelombang —', category:'gelombang', photoCount:2, cells:[{x:0,y:0,w:100,h:100,clip:'0 0,100 0,100 46,92 50,83 55,75 57,67 55,58 50,50 45,42 43,33 46,25 52,17 54,8 52,0 48'},{x:0,y:0,w:100,h:100,clip:'0 48,8 52,17 54,25 52,33 46,42 43,50 45,58 50,67 55,75 57,83 55,92 50,100 46,100 100,0 100'}] },
  { id:'g2_ripple',name:'2 Riak', category:'gelombang', photoCount:2, cells:[{x:0,y:0,w:100,h:100,clip:'0 0,100 0,100 35,88 38,75 46,63 54,50 58,38 54,25 46,13 38,0 35'},{x:0,y:0,w:100,h:100,clip:'0 35,13 38,25 46,38 54,50 58,63 54,75 46,88 38,100 35,100 100,0 100'}] },
...
// HELPERS
// =============================================
const calcMaxOffset = (imgW:number, imgH:number, cellW:number, cellH:number, scale:number) => {
  if (imgW<=0||imgH<=0) return { maxOffX:1, maxOffY:1 };
  const cs = Math.min(cellW/imgW, cellH/imgH);
  const vW = imgW*cs*scale, vH = imgH*cs*scale;
  return {
    maxOffX: ((cellW+vW)/2 - vW*0.2) / (cellW*scale),
    maxOffY: ((cellH+vH)/2 - vH*0.2) / (cellH*scale),
  };
};
...
const CellEditor: React.FC<CellEditorProps> = ({ cs,idx,isDragOver,isSelected,onSelect,onUpdate,onUpload,onRemove,onDragOver,onDragLeave,onDrop }) => {
  const containerRef = useRef<HTMLDivElement>(null);
  const isDragging   = useRef(false);
  const touchStart   = useRef({ x:0, y:0, offX:0, offY:0 });
  const pinchStart   = useRef({ dist:0, scale:1, offX:0, offY:0 });
  const isPinching   = useRef(false);

  const handleMouseDown = (e:React.MouseEvent) => {
    if (!cs.imageSrc) return;
    e.preventDefault(); onSelect(idx); isDragging.current = true;
    const sX=e.clientX, sY=e.clientY, sOX=cs.offsetX, sOY=cs.offsetY;
    const onMove = (ev:MouseEvent) => {
      if (!isDragging.current||!containerRef.current) return;
      const r=containerRef.current.getBoundingClientRect();
      const {maxOffX,maxOffY}=calcMaxOffset(cs.imgNaturalW,cs.imgNaturalH,r.width,r.height,cs.scale);
      onUpdate(idx,{
        offsetX:Math.max(-maxOffX,Math.min(maxOffX,sOX+(ev.clientX-sX)/(r.width*cs.scale))),
        offsetY:Math.max(-maxOffY,Math.min(maxOffY,sOY+(ev.clientY-sY)/(r.height*cs.scale))),
      });
    };
  ...
  const handleTouchStart = (e:React.TouchEvent) => {
    if (!cs.imageSrc) return; e.preventDefault(); onSelect(idx);
    if (e.touches.length===2) {
      isPinching.current=true; isDragging.current=false;
      pinchStart.current={dist:dist2(e.touches),scale:cs.scale,offX:cs.offsetX,offY:cs.offsetY};
  ...
  const handleTouchMove = (e:React.TouchEvent) => {
    if (!cs.imageSrc||!containerRef.current) return; e.preventDefault();
    const r=containerRef.current.getBoundingClientRect();
    if (e.touches.length===2&&isPinching.current) {
      const ns=Math.max(0.3,Math.min(3,pinchStart.current.scale*dist2(e.touches)/pinchStart.current.dist));
      const {maxOffX,maxOffY}=calcMaxOffset(cs.imgNaturalW,cs.imgNaturalH,r.width,r.height,ns);
      onUpdate(idx,{scale:ns,offsetX:Math.max(-maxOffX,Math.min(maxOffX,pinchStart.current.offX)),offsetY:Math.max(-maxOffY,Math.min(maxOffY,pinchStart.current.offY))});
    } else if (e.touches.length===1&&isDragging.current&&!isPinching.current) {
      const {maxOffX,maxOffY}=calcMaxOffset(cs.imgNaturalW,cs.imgNaturalH,r.width,r.height,cs.scale);
      onUpdate(idx,{
        offsetX:Math.max(-maxOffX,Math.min(maxOffX,touchStart.current.offX+(e.touches[0].clientX-touchStart.current.x)/(r.width*cs.scale))),
        offsetY:Math.max(-maxOffY,Math.min(maxOffY,touchStart.current.offY+(e.touches[0].clientY-touchStart.current.y)/(r.height*cs.scale))),
      });
    }
  };
  ...
  const imgStyle:React.CSSProperties = cs.imageSrc ? {
  ...
  return (
    <div className="relative w-full h-full" onDragOver={e=>onDragOver(e,idx)} onDragLeave={onDragLeave} onDrop={e=>onDrop(e,idx)}>
      <div ref={containerRef}
        ...
        {cs.imageSrc ? (
          <>
            <img src={cs.imageSrc} alt="" draggable={false} style={imgStyle}/>
            ...
            {isSelected&&<div className="absolute bottom-1 right-1 pointer-events-none"><span className="text-[8px] text-white/70 bg-black/60 px-1 py-0.5 rounded">✋ geser</span></div>}
          </>
        ) : isDragOver ? (
    ...
    <div className="p-3 space-y-3">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex gap-1 pt-4">
          <button type="button" onClick={()=>setBold(v=>!v)} className={`w-8 h-8 rounded-lg text-sm font-bold transition-colors ${bold?'bg-indigo-600 text-white':'bg-slate-700 text-slate-400'}`}>B</button>
          <button type="button" onClick={()=>setItalic(v=>!v)} className={`w-8 h-8 rounded-lg text-sm italic transition-colors ${italic?'bg-indigo-600 text-white':'bg-slate-700 text-slate-400'}`}>I</button>
          <button type="button" onClick={()=>setShadow(v=>!v)} className={`w-8 h-8 rounded-lg text-sm transition-colors ${shadow?'bg-indigo-600 text-white':'bg-slate-700 text-slate-400'}`}>S</button>
        </div>
      </div>
...
const CollageEditor: React.FC = () => {
  ...
  // Callback stabil — useCallback dengan deps kosong karena setLayers/setSelectedLayer
  // adalah stable dispatch functions dari React dan tidak perlu di-deps.
  ...
  const matchingLayouts = filledCount>0
    ? COLLAGE_LAYOUTS.filter(l=>l.photoCount===filledCount&&(filterCat===null||l.category===filterCat))
    : [];

  const handleSelectLayout = useCallback((layout:CollageLayout) => {
    setSelectedLayout(layout); setSelectedCell(null);
    setCells(layout.cells.map((_,i)=>{
      const s=staged[i];
      return s?{imageSrc:s.imageSrc,imgNaturalW:s.imgNaturalW,imgNaturalH:s.imgNaturalH,scale:1,offsetX:0,offsetY:0}:DEFAULT_CELL();
    }));
  },[staged]);

  useEffect(()=>{
    if (!selectedLayout) return;
    if (filledCount!==selectedLayout.photoCount){setSelectedLayout(null);setCells([]);return;}
    setCells(prev=>selectedLayout.cells.map((_,i)=>{
      const s=staged[i],ex=prev[i];
      if(s) return ex?.imageSrc===s.imageSrc?ex:{imageSrc:s.imageSrc,imgNaturalW:s.imgNaturalW,imgNaturalH:s.imgNaturalH,scale:1,offsetX:0,offsetY:0};
      return DEFAULT_CELL();
    }));
  ...
  const uploadToStaged = useCallback((i:number,file:File)=>{
    ...
    r.onload=e=>{const src=e.target?.result as string;const img=new Image();img.onload=()=>setStaged(p=>{const n=[...p];n[i]={imageSrc:src,imgNaturalW:img.naturalWidth,imgNaturalH:img.naturalHeight};return n;});img.src=src;};
  ...
  const uploadMultiple = useCallback((files:FileList)=>{
    Array.from(files).filter(f=>f.type.startsWith('image/')).slice(0,6).forEach(file=>{
      const r=new FileReader();
      r.onload=e=>{const src=e.target?.result as string;const img=new Image();img.onload=()=>setStaged(p=>{const n=[...p];let slot=n.findIndex(s=>!s);if(slot===-1){if(n.length<6){n.push(null);slot=n.length-1;}else return n;}n[slot]={imageSrc:src,imgNaturalW:img.naturalWidth,imgNaturalH:img.naturalHeight};return n;});img.src=src;};
      r.readAsDataURL(file);
    });
  },[]);

  const addSlot    = useCallback(()=>{if(staged.length<6)setStaged(p=>[...p,null]);},[staged.length]);
  const removeSlot = useCallback((i:number)=>{setStaged(p=>{const n=p.filter((_,idx)=>idx!==i);return n.length===0?[null]:n;});setSelectedLayout(null);setCells([]);setSelectedCell(null);},[]);
  const updateCell = useCallback((i:number,patch:Partial<CellState>)=>setCells(p=>p.map((c,ci)=>ci!==i?c:{...c,...patch})),[]);
  ...
  const handleDrop       = useCallback((e:React.DragEvent,i:number)=>{e.preventDefault();setDragOverCell(null);const f=e.dataTransfer.files[0];if(f)uploadToStaged(i,f);},[uploadToStaged]);
  ...
  const getCellStyle = useCallback((cell:CollageCell):React.CSSProperties=>{
    ...
    return{position:'absolute',left:`${cell.x}%`,top:`${cell.y}%`,width:`${cell.w}%`,height:`${cell.h}%`,
      paddingTop:cell.y<eps?0:g,paddingBottom:cell.y+cell.h>100-eps?0:g,
      paddingLeft:cell.x<eps?0:g,paddingRight:cell.x+cell.w>100-eps?0:g};
  },[gap]);

  const handleScaleChange = useCallback((i:number,ns:number)=>{
    setCells(p=>p.map((c,ci)=>{
      if(ci!==i)return c;
      const{maxOffX,maxOffY}=calcMaxOffset(c.imgNaturalW||1,c.imgNaturalH||1,c.imgNaturalW||1,c.imgNaturalH||1,ns);
      return{...c,scale:ns,offsetX:Math.max(-maxOffX,Math.min(maxOffX,c.offsetX)),offsetY:Math.max(-maxOffY,Math.min(maxOffY,c.offsetY))};
    }));
  },[]);

  const addStickerLayer = useCallback((symbol:string)=>{
    const l:StickerLayer={kind:'sticker',id:`s_${Date.now()}`,symbol,size:48,x:50,y:50,rotation:0};
    setLayers(p=>[...p,l]);setSelectedLayer(l.id);
  },[]);
  const updateLayer = useCallback((id:string,patch:Partial<Layer>)=>setLayers(p=>p.map(l=>l.id!==id?l:{...l,...patch}as Layer)),[]);
  const removeLayer = useCallback((id:string)=>{setLayers(p=>p.filter(l=>l.id!==id));setSelectedLayer(null);},[]);

  const handleLayerMouseDown = useCallback((e:React.MouseEvent,id:string,lx:number,ly:number)=>{
    e.stopPropagation();setSelectedLayer(id);
    ...
    const onMove=(ev:MouseEvent)=>{
      ...
      updateLayer(layerDrag.current.id,{x:Math.max(0,Math.min(100,layerDrag.current.origX+(ev.clientX-layerDrag.current.startX)/r.width*100)),y:Math.max(0,Math.min(100,layerDrag.current.origY+(ev.clientY-layerDrag.current.startY)/r.height*100))});
    };
    const onUp=()=>{layerDrag.current=null;window.removeEventListener('mousemove',onMove);window.removeEventListener('mouseup',onUp);};
    window.addEventListener('mousemove',onMove);window.addEventListener('mouseup',onUp);
  },[updateLayer]);

  const handleLayerTouchStart = useCallback((e:React.TouchEvent,id:string,lx:number,ly:number,sz:number)=>{
    e.stopPropagation();setSelectedLayer(id);
    if(e.touches.length===2){
      layerDrag.current=null;
      const d=Math.hypot(e.touches[0].clientX-e.touches[1].clientX,e.touches[0].clientY-e.touches[1].clientY);
      layerPinch.current={id,startDist:d,startSize:sz};
      const onMove=(ev:TouchEvent)=>{if(!layerPinch.current||ev.touches.length<2)return;ev.preventDefault();const nd=Math.hypot(ev.touches[0].clientX-ev.touches[1].clientX,ev.touches[0].clientY-ev.touches[1].clientY);updateLayer(layerPinch.current.id,{size:Math.max(10,Math.min(200,Math.round(layerPinch.current.startSize*nd/layerPinch.current.startDist)))});};
      const onEnd=(ev:TouchEvent)=>{if(ev.touches.length<2){layerPinch.current=null;window.removeEventListener('touchmove',onMove);window.removeEventListener('touchend',onEnd);}};
    ...
    const onMove=(ev:TouchEvent)=>{if(!layerDrag.current||ev.touches.length!==1||!previewRef.current)return;ev.preventDefault();const r=previewRef.current.getBoundingClientRect();updateLayer(layerDrag.current.id,{x:Math.max(0,Math.min(100,layerDrag.current.origX+(ev.touches[0].clientX-layerDrag.current.startX)/r.width*100)),y:Math.max(0,Math.min(100,layerDrag.current.origY+(ev.touches[0].clientY-layerDrag.current.startY)/r.height*100))});};
    const onEnd=()=>{layerDrag.current=null;window.removeEventListener('touchmove',onMove);window.removeEventListener('touchend',onEnd);};
    window.addEventListener('touchmove',onMove,{passive:false});window.addEventListener('touchend',onEnd);
  },[updateLayer]);
  ...
  const handleExport = async () => {
    ...
    setIsExporting(true);
    try{
      const[eW,eH]=aspectRatio.split(':').map(Number);
      const W=1080,H=Math.round(W*eH/eW),gPx=gap,eps=0.05;
      const canvas=document.createElement('canvas');canvas.width=W;canvas.height=H;
      const ctx=canvas.getContext('2d')!;ctx.fillStyle=bgColor;ctx.fillRect(0,0,W,H);
      for(let i=0;i<selectedLayout.cells.length;i++){
        const cell=selectedLayout.cells[i],cs=cells[i];
        ...
        else{const pT=cell.y<eps?0:gPx/2,pB=cell.y+cell.h>100-eps?0:gPx/2,pL=cell.x<eps?0:gPx/2,pR=cell.x+cell.w>100-eps?0:gPx/2;cX=(cell.x/100)*W+pL;cY=(cell.y/100)*H+pT;cW=(cell.w/100)*W-pL-pR;cH=(cell.h/100)*H-pT-pB;}
        const sc=Math.min(cW/img.naturalWidth,cH/img.naturalHeight);
        const fW=img.naturalWidth*sc*cs.scale,fH=img.naturalHeight*sc*cs.scale;
        const dX=(cX+cW/2)+cs.offsetX*cW*cs.scale-fW/2,dY=(cY+cH/2)+cs.offsetY*cH*cs.scale-fH/2;
        ctx.save();ctx.beginPath();
        if(cell.clip){const pts=cell.clip.split(',').map(p=>{const[x,y]=p.trim().split(' ');return{x:parseFloat(x)/100*W,y:parseFloat(y)/100*H};});ctx.moveTo(pts[0].x,pts[0].y);for(let j=1;j<pts.length;j++)ctx.lineTo(pts[j].x,pts[j].y);ctx.closePath();}
        else ctx.rect(cX,cY,cW,cH);
        ctx.clip();ctx.drawImage(img,dX,dY,fW,fH);ctx.restore();
      }
      for(const layer of layers){
        ctx.save();ctx.translate(layer.x/100*W,layer.y/100*H);ctx.rotate(layer.rotation*Math.PI/180);
        if(layer.kind==='text'){
          const tl=layer as TextLayer;
          ctx.font=`${tl.italic?'italic ':''}${tl.bold?'bold ':''}${tl.size*(W/400)}px ${FONTS.find(f=>f.id===tl.font)?.css||'Arial'}`;
          ctx.textAlign='center';ctx.textBaseline='middle';
          if(tl.shadow){ctx.shadowColor='rgba(0,0,0,0.7)';ctx.shadowBlur=tl.size*0.15*(W/400);ctx.shadowOffsetX=2;ctx.shadowOffsetY=2;}
          ctx.fillStyle=tl.color;ctx.fillText(tl.text,0,0);
        }else{const sl=layer as StickerLayer;ctx.font=`${sl.size*(W/400)}px serif`;ctx.textAlign='center';ctx.textBaseline='middle';ctx.fillText(sl.symbol,0,0);}
        ctx.restore();
      }
      canvas.toBlob(blob=>{if(!blob)return;const url=URL.createObjectURL(blob);const a=document.createElement('a');a.href=url;a.download=`kolase_${Date.now()}.png`;document.body.appendChild(a);a.click();requestAnimationFrame(()=>{document.body.removeChild(a);URL.revokeObjectURL(url);});},'image/png');
  ...
  return (
    <div className="space-y-6" data-collage-area="true">
      ...
      <div className="flex items-center gap-2">
        {[{n:1,label:'Upload Foto'},{n:2,label:'Pilih Layout'},{n:3,label:'Atur & Download'}].map((s,idx)=>(
          <React.Fragment key={s.n}>
            <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold transition-all ${step===s.n?'bg-indigo-600 text-white shadow-lg':step>s.n?'bg-indigo-900/50 text-indigo-400':'bg-slate-700/50 text-slate-500'}`}>
              <span className={`w-4 h-4 rounded-full flex items-center justify-center text-[10px] font-bold flex-shrink-0 ${step>s.n?'bg-indigo-500 text-white':step===s.n?'bg-white text-indigo-600':'bg-slate-600 text-slate-400'}`}>{step>s.n?'✓':s.n}</span>
              {s.label}
            </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div className="space-y-5">
          ...
          <div className={`rounded-xl border transition-all ${step===1?'border-indigo-500/60 bg-indigo-950/20':'border-slate-700 bg-slate-800/30'}`}>
            <div className="flex items-center justify-between px-4 py-3 border-b border-slate-700/50">
              ...
              <div className="flex items-center gap-2">
                ...
                {staged.length<6&&<button type="button" onClick={addSlot} className="text-xs text-indigo-400 hover:text-indigo-300 transition-colors">+ Slot</button>}
              </div>
            </div>
            <div className="p-3">
                ...
                {staged.map((photo,i)=>{
                  ...
                  return (
                    <div key={i} className="relative aspect-square">
                      <div className={`w-full h-full rounded-lg overflow-hidden border-2 border-dashed transition-all ${photo?'border-transparent':isOver?'border-indigo-400 bg-slate-700':'border-slate-600 bg-slate-800/50 hover:border-slate-500'}`}
                        onDragOver={e=>{e.preventDefault();setDragOverStaged(i);}} onDragLeave={()=>setDragOverStaged(null)}
                          ...
                          <>
                            ...
                            <div className="absolute inset-0 bg-black/50 opacity-0 hover:opacity-100 transition-opacity flex items-center justify-center gap-1">
                              <label className="cursor-pointer p-1 bg-slate-700 hover:bg-slate-600 rounded text-[10px] text-white">
                                Ganti
                                <input type="file" accept="image/*" multiple className="hidden" onChange={e=>{if(!e.target.files?.length)return;const files=Array.from(e.target.files);setStaged(prev=>{let n=[...prev];while(n.length<Math.min(6,i+files.length))n.push(null);return n;});files.forEach((f,fi)=>{if(i+fi<6)uploadToStaged(i+fi,f);});e.target.value='';}}/>
                              </label>
              ...
              <label className="flex items-center justify-center gap-2 w-full mt-2 py-2 rounded-lg border border-dashed border-indigo-500/40 bg-indigo-950/20 hover:bg-indigo-950/40 cursor-pointer transition-colors">
                <input type="file" accept="image/*" multiple className="hidden" onChange={e=>{if(!e.target.files)return;uploadMultiple(e.target.files);e.target.value='';}}/>
                <svg className="w-4 h-4 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"/></svg>
              ...
              {filledCount===0&&<p className="text-[10px] text-slate-500 text-center mt-1">Layout muncul otomatis sesuai jumlah foto yang diupload</p>}
              {filledCount>0&&!selectedLayout&&<p className="text-[10px] text-indigo-400 text-center mt-1 animate-pulse">✓ {filledCount} foto siap — pilih layout di bawah</p>}
            </div>
          </div>
          ...
          {selectedLayout&&(
            <div className="rounded-xl border border-slate-700 bg-slate-800/30">
              ...
              {/* TextForm: React.memo + useCallback = tidak pernah re-render.
                  Conditional render (bukan display:none) agar tidak ada masalah
                  ref pada uncontrolled textarea di React 19. */}
              {activeTab === 'teks' && (
                ...
                {[...layers].reverse().map(layer=>{
                  ...
                  return (
                    <div key={layer.id} onClick={()=>setSelectedLayer(isSel?null:layer.id)}
                      ...
                      {isSel&&<input type="range" min={layer.kind==='text'?14:20} max={layer.kind==='text'?120:150} value={layer.size} onChange={e=>updateLayer(layer.id,{size:Number(e.target.value)})} className="w-16 h-1.5 rounded-full appearance-none cursor-pointer accent-indigo-500 bg-slate-600" onClick={e=>e.stopPropagation()}/>}
                      <button type="button" onClick={e=>{e.stopPropagation();removeLayer(layer.id);}} className="w-5 h-5 flex-shrink-0 bg-red-600/60 hover:bg-red-500 rounded text-[10px] text-white flex items-center justify-center">✕</button>
                    </div>
                  );
                })}
              </div>
          ...
          {filledCount>0&&(
            <div className={`rounded-xl border transition-all ${!selectedLayout?'border-indigo-500/60 bg-indigo-950/20':'border-slate-700 bg-slate-800/30'}`}>
              <div className="flex items-center gap-2 px-4 py-3 border-b border-slate-700/50">
                <span className={`w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold ${selectedLayout?'bg-indigo-500 text-white':'bg-indigo-600 text-white'}`}>{selectedLayout?'✓':'2'}</span>
                <span className="text-sm font-semibold text-white">Pilih Layout</span>
                <span className="text-xs text-slate-400 bg-indigo-600/20 px-2 py-0.5 rounded-full">{matchingLayouts.length} layout untuk {filledCount} foto</span>
              </div>
              <div className="p-3 space-y-3">
                <div className="flex gap-1.5 flex-wrap">
                  <button type="button" onClick={()=>setFilterCat(null)} className={`px-2.5 py-1 rounded-full text-xs font-semibold transition-colors ${filterCat===null?'bg-purple-600 text-white':'bg-slate-700 text-slate-400 hover:bg-slate-600'}`}>Semua</button>
                  {categories.map(cat=>{
                    if(!COLLAGE_LAYOUTS.some(l=>l.photoCount===filledCount&&l.category===cat))return null;
                    return <button key={cat} type="button" onClick={()=>setFilterCat(cat===filterCat?null:cat)} className={`px-2.5 py-1 rounded-full text-xs font-semibold transition-colors ${filterCat===cat?'bg-purple-600 text-white':'bg-slate-700 text-slate-400 hover:bg-slate-600'}`}>{CATEGORY_LABELS[cat]}</button>;
                  })}
                </div>
                          ...
                          <div className="aspect-square bg-black">
                            <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style={{display:'block',width:'100%',height:'100%'}}>
                              {layout.cells.map((cell,ci)=>{
                                ...
                                if(cell.clip){const pts=cell.clip.split(',').map(p=>p.trim().split(' ').join(',')).join(' ');return <polygon key={ci} points={pts} fill={fill} stroke="#000" strokeWidth="2"/>;}
                                return <rect key={ci} x={cell.x+0.75} y={cell.y+0.75} width={cell.w-1.5} height={cell.h-1.5} fill={fill} stroke="#000" strokeWidth="1.5"/>;
                              })}
                            </svg>
                          </div>
                          <div className="bg-slate-800 px-1 py-0.5"><p className="text-[8px] text-slate-400 truncate text-center">{layout.name}</p></div>
                        </button>
                      );
                    })}
                  </div>
            ...
            <div className="rounded-xl border border-slate-700 bg-slate-800/30 overflow-hidden">
              ...
              <div className="p-4 space-y-4">
                ...
                <div>
                  ...
                  <input type="range" min={0} max={24} value={gap} onChange={e=>setGap(Number(e.target.value))} className="w-full h-2 rounded-full appearance-none cursor-pointer accent-indigo-500 bg-slate-700"/>
                  {selectedLayout.cells.some(c=>c.clip)&&<p className="text-[10px] text-amber-400/60 mt-1">⚡ Jarak tidak berlaku untuk layout berbentuk</p>}
                </div>
                <div>
                  ...
                  <div className="flex items-center gap-2 mb-1.5">
                    ...
                    <input type="text" value={bgColor} onChange={e=>setBgColor(e.target.value)} className="flex-1 bg-slate-700 border border-slate-600 rounded-lg px-2 py-1.5 text-white text-xs font-mono focus:outline-none focus:border-indigo-500"/>
                  </div>
                  <div className="flex gap-1.5 flex-wrap">
                    {BG_PRESETS.map(c=>(
                      <button key={c} type="button" onClick={()=>setBgColor(c)}
                        className={`w-6 h-6 rounded-full border-2 transition-all hover:scale-110 ${bgColor===c?'border-white scale-110':'border-slate-600'}`} style={{background:c}}/>
                    ))}
                  </div>
                </div>
              </div>
        ...
        <div>
          {!selectedLayout ? (
            <div className="w-full rounded-xl overflow-hidden ring-1 ring-slate-700 bg-slate-800/50 flex flex-col items-center justify-center py-16 gap-4 text-center px-6" style={{minHeight:'280px'}}>
              {filledCount===0 ? (
                <><svg className="w-12 h-12 text-slate-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                <div><p className="text-slate-400 font-semibold">Upload foto dulu</p><p className="text-xs text-slate-600 mt-1">Layout akan muncul otomatis sesuai jumlah foto</p></div></>
              ) : (
                <><div className="text-4xl">🖼️</div>
                <div><p className="text-slate-400 font-semibold">{filledCount} foto siap</p><p className="text-xs text-slate-600 mt-1">Pilih layout dari panel kiri untuk melihat preview</p></div></>
              )}
            </div>
          ) : (
            <>
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-2">
                  <span className={`text-[9px] px-1.5 py-0.5 rounded font-semibold ${selectedLayout.category==='diagonal'?'bg-amber-600/30 text-amber-300':selectedLayout.category==='chevron'?'bg-green-600/30 text-green-300':selectedLayout.category==='gelombang'?'bg-blue-600/30 text-blue-300':'bg-slate-600/30 text-slate-400'}`}>{CATEGORY_LABELS[selectedLayout.category]}</span>
                  <span className="text-xs text-slate-500 italic">{selectedLayout.name}</span>
                  <button type="button" onClick={()=>{setSelectedLayout(null);setCells([]);setSelectedCell(null);}} className="text-[10px] text-slate-500 hover:text-red-400 transition-colors">✕ ganti</button>
                </div>
              </div>

              <div ref={previewRef} className="w-full rounded-xl shadow-2xl ring-1 ring-slate-700"
                style={{position:'relative',paddingBottom:`${(arH/arW)*100}%`}} onClick={()=>setSelectedLayer(null)}>
                <div className="absolute inset-0 rounded-xl overflow-hidden" style={{background:bgColor}}>
                  {selectedLayout.cells.map((cell,i)=>(
                    <div key={`${selectedLayout.id}-${i}`} style={getCellStyle(cell)}>
                      <CellEditor cs={cells[i]??DEFAULT_CELL()} idx={i} isDragOver={dragOverCell===i} isSelected={selectedCell===i}
                        onSelect={setSelectedCell} onUpdate={updateCell} onUpload={(i,f)=>uploadToStaged(i,f)} onRemove={handleRemoveCell}
                ...
                {layers.map(layer=>{
                  const isSel=selectedLayer===layer.id;
                  const tl=layer as TextLayer; const sl=layer as StickerLayer;
                  return (
                    <div key={layer.id} style={{position:'absolute',left:`${layer.x}%`,top:`${layer.y}%`,transform:`translate(-50%,-50%) rotate(${layer.rotation}deg)`,cursor:'grab',userSelect:'none',zIndex:10,padding:'3px 6px',borderRadius:'4px',boxSizing:'border-box',outline:isSel?'2px dashed #818cf8':'none',outlineOffset:'2px',touchAction:'none'}}
                      ...
                      {layer.kind==='text'?(
                        <span style={{display:'block',fontFamily:FONTS.find(f=>f.id===tl.font)?.css||'Arial',fontSize:`${layer.size}px`,fontWeight:tl.bold?'bold':'normal',fontStyle:tl.italic?'italic':'normal',color:tl.color,textShadow:tl.shadow?'2px 2px 6px rgba(0,0,0,1),-1px -1px 3px rgba(0,0,0,0.8)':'none',whiteSpace:'nowrap',lineHeight:1.2}}>{tl.text}</span>
                      ):(
                        <span style={{display:'block',fontSize:`${layer.size}px`,lineHeight:1}}>{sl.symbol}</span>
                      )}
                      {isSel&&<span style={{position:'absolute',bottom:-18,left:'50%',transform:'translateX(-50%)',fontSize:9,color:'rgba(255,255,255,0.6)',background:'rgba(0,0,0,0.5)',padding:'1px 5px',borderRadius:4,whiteSpace:'nowrap',pointerEvents:'none'}}>🤏 pinch untuk resize</span>}
                      {isSel&&<button type="button" onClick={e=>{e.stopPropagation();removeLayer(layer.id);}} style={{position:'absolute',top:-10,right:-10,width:20,height:20,background:'#ef4444',borderRadius:'50%',border:'2px solid white',color:'white',fontSize:10,cursor:'pointer',display:'flex',alignItems:'center',justifyContent:'center',zIndex:20}}>✕</button>}
                    </div>
                  );
                })}
              </div>
              ...
              <div className={`mt-3 rounded-xl border transition-all duration-200 overflow-hidden ${selCs?.imageSrc?'border-indigo-500/50 bg-indigo-950/30':'border-slate-700/50 bg-slate-800/30'}`}>
                <div className="flex items-center justify-between px-3 py-2 border-b border-slate-700/40">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-semibold text-slate-300">{selectedCell!==null&&selCs?.imageSrc?`Zoom Foto ${selectedCell+1}`:'Klik foto untuk zoom & geser'}</span>
                  </div>
                  {selCs?.imageSrc&&(
                    <div className="flex items-center gap-2">
                      ...
                      <button type="button" onClick={()=>updateCell(selectedCell!,{scale:1,offsetX:0,offsetY:0})} className="text-xs text-slate-400 hover:text-white px-2 py-0.5 rounded bg-slate-700/50 hover:bg-slate-700 transition-colors">↺ Reset</button>
                    </div>
                  )}
                </div>
                <div className="px-3 py-3">
                  {selCs?.imageSrc ? (
                    <div className="space-y-1.5">
                      <div className="flex items-center gap-2">
                        <button type="button" onClick={()=>handleScaleChange(selectedCell!,Math.max(0.3,selCs.scale-0.1))} className="w-10 h-10 flex-shrink-0 bg-slate-700 hover:bg-slate-600 active:bg-slate-500 text-white rounded-xl flex items-center justify-center text-xl font-bold transition-colors select-none touch-manipulation">−</button>
                        <input type="range" min={30} max={300} step={1} value={Math.round(selCs.scale*100)} onChange={e=>handleScaleChange(selectedCell!,Number(e.target.value)/100)} className="flex-1 h-3 rounded-full appearance-none cursor-pointer accent-indigo-500 bg-slate-700"/>
                        <button type="button" onClick={()=>handleScaleChange(selectedCell!,Math.min(3,selCs.scale+0.1))} className="w-10 h-10 flex-shrink-0 bg-slate-700 hover:bg-slate-600 active:bg-slate-500 text-white rounded-xl flex items-center justify-center text-xl font-bold transition-colors select-none touch-manipulation">+</button>
                      </div>
                      <div className="flex justify-between text-[10px] text-slate-500 px-12"><span>Kecil</span><span>✋ Drag foto untuk geser</span><span>Zoom</span></div>
                    </div>
                  ) : (
              ...
              <div className="mt-2 text-[10px] text-slate-600 text-center">Layout diagonal/gelombang: ubah warna background untuk efek pemisah berbeda</div>
            </>
          )}
        </div>
      </div>
